...
function Header() {
    return (
        <header>
            <div className="bg-gray-100 min-w-full flex justify-evenly pr-10 pt-1 pb-1 font-semibold text-sm text-center sm:text-right"><p>Sales: 888.000.000 </p> <p>Support</p> <p>Login</p></div>
